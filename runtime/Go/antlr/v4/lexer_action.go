...
// indexes.
//
//  ruleIndex The rule index to use for calls to
// {@link Recognizer//action}.
//  actionIndex The action index to use for calls to
// {@link Recognizer//action}.
...
//
//	channel The channel value to pass to {@link Lexer//setChannel}.

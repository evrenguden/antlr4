...
// type="image/svg+xml"/></p>
//
//	a the first {@link SingletonBasePredictionContext}
//	b the second {@link SingletonBasePredictionContext}
//	rootIsWildcard {@code true} if this is a local-context merge,
//
